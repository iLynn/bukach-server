...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserFeedback.feedback_content'
        db.alter_column('bukach_userfeedback', 'feedback_content', self.gf('django.db.models.fields.TextField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'UserFeedback.feedback_content'
        db.alter_column('bukach_userfeedback', 'feedback_content', self.gf('django.db.models.fields.CharField')(max_length=1000))
