...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GraceInfo.grace_create_time'
        db.add_column('bukach_graceinfo', 'grace_create_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 6, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GraceInfo.grace_create_time'
        db.delete_column('bukach_graceinfo', 'grace_create_time')
    ...
    models = {
        ...
        'bukach.graceinfo': {
            ...
            'grace_create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
