...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AboutUsInfo'
        db.create_table('bukach_aboutusinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('about_us_detail', self.gf('django.db.models.fields.CharField')(default='', max_length=1000)),
        ))
        db.send_create_signal('bukach', ['AboutUsInfo'])

        # Adding model 'JobInfo'
        db.create_table('bukach_jobinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job_type', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('job_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('job_detail', self.gf('django.db.models.fields.CharField')(default='', max_length=500)),
            ('job_quota', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('resume_to', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('job_deadline', self.gf('django.db.models.fields.CharField')(default='long term', max_length=50)),
        ))
        db.send_create_signal('bukach', ['JobInfo'])


    def backwards(self, orm):
        # Deleting model 'AboutUsInfo'
        db.delete_table('bukach_aboutusinfo')

        # Deleting model 'JobInfo'
        db.delete_table('bukach_jobinfo')


    models = {
        'bukach.aboutusinfo': {
            'Meta': {'object_name': 'AboutUsInfo'},
            'about_us_detail': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000'}),
        ...
        'bukach.jobinfo': {
            ...
            'job_detail': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
