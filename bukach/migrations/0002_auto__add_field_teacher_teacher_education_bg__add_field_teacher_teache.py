...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Teacher.teacher_education_bg'
        db.add_column('bukach_teacher', 'teacher_education_bg',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Teacher.teacher_award'
        db.add_column('bukach_teacher', 'teacher_award',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Teacher.teacher_level'
        db.add_column('bukach_teacher', 'teacher_level',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding field 'CourseCategory.category_order'
        db.add_column('bukach_coursecategory', 'category_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Teacher.teacher_education_bg'
        db.delete_column('bukach_teacher', 'teacher_education_bg')

        # Deleting field 'Teacher.teacher_award'
        db.delete_column('bukach_teacher', 'teacher_award')

        # Deleting field 'Teacher.teacher_level'
        db.delete_column('bukach_teacher', 'teacher_level')

        # Deleting field 'CourseCategory.category_order'
        db.delete_column('bukach_coursecategory', 'category_order')
