...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GraceInfo.grace_img_str'
        db.add_column('bukach_graceinfo', 'grace_img_str',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GraceInfo.grace_img_str'
        db.delete_column('bukach_graceinfo', 'grace_img_str')
    ...
    models = {
        ...
        'bukach.graceinfo': {
            ...
            'grace_img_str': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '1000'}),
