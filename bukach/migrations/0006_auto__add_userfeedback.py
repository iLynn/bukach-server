...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bukach_userfeedback', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feedback_content', self.gf('django.db.models.fields.CharField')(default='', max_length=1000)),
            ('feedback_email', self.gf('django.db.models.fields.EmailField')(default='example@126.com', max_length=75)),
            ('feedback_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=15)),
            ('feedback_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('bukach', ['UserFeedback'])


    def backwards(self, orm):
        # Deleting model 'UserFeedback'
        db.delete_table('bukach_userfeedback')
